    ...
    The Public APIs repository is a manually curated list maintained by community members like you and [APILayer](https://apilayer.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo) team members. It includes an extensive list of public APIs from many domains that you can use for your own products. Consider it a treasure trove of APIs well-managed by the community over the years.
    ...
    **[⬆ Back to Index](#index)**
    ...
    | [Covid-19 Live Data](https://github.com/mathdroid/covid-19-api) | Global and country-wise data of Covid-19 daily Summary, confirmed cases, recovered and deaths | No | Yes | Yes |
    ...
    | [Nutritionix](https://developer.nutritionix.com/) | World's largest verified nutrition database | `apiKey` | Yes | Unknown |
    ...
    **[⬆ Back to Index](#index)**
    ...
    | [JioSaavn](https://github.com/cyberboysumanjay/JioSaavnAPI) | API to retrieve song information, album metadata and many more from JioSaavn | No | Yes | Unknown |
    ...
    **[⬆ Back to Index](#index)**
    ...
    | [PatentsView ](https://patentsview.org/apis/purpose) | The API is intended to explore and visualize trends/patterns across the US innovation landscape | No | Yes | Unknown |
